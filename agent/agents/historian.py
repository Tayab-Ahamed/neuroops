...
class HistorianOutput(BaseModel):
    ...
    suspect_commit: Optional[str] = Field(description="The commit hash of a suspect deployment, if any")
    deploy_time: Optional[str] = Field(description="The timestamp of the suspect deployment, if any")
