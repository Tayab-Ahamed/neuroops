...
def test_k8s_get_pod_status_mock():
    ...
    # 1. Test OOM pod name
    res_oom = k8s_tools.get_pod_status.func(**{"namespace": "default", "pod_name": "backend-oom-123"})
    assert "OOMKilled" in res_oom
    
    # 2. Test Crash pod name
    res_crash = k8s_tools.get_pod_status.func(**{"namespace": "default", "pod_name": "backend-crash-123"})
    assert "CrashLoopBackOff" in res_crash
    
    # 3. Test default pod name
    res_normal = k8s_tools.get_pod_status.func(**{"namespace": "default", "pod_name": "backend-normal"})
...
def test_k8s_get_deployment_history_mock():
    k8s_tools.k8s_configured = False
    res = k8s_tools.get_deployment_history.func(**{"namespace": "default", "deployment_name": "backend"})
...
def test_k8s_get_recent_events_mock():
    k8s_tools.k8s_configured = False
    res = k8s_tools.get_recent_events.func(**{"namespace": "default", "service_name": "backend", "minutes": 10})
...
def test_prometheus_compare_services_mock():
    ...
    res_latency = prometheus_tools.compare_services.func(**{"metric": "latency", "time_window": "5m"})
    ...
    res_traffic = prometheus_tools.compare_services.func(**{"metric": "traffic", "time_window": "5m"})
