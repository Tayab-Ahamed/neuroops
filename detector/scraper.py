...
class PrometheusScraper:
    ...
    def _normalize_service_name(self, raw_name: str) -> Optional[str]:
    ...
    def scrape_metrics(self) -> List[MetricWindow]:
        ...
        error_requests_count: Dict[str, float] = {svc: 0.0 for svc in self.target_services}
        total_requests_count: Dict[str, float] = {svc: 0.0 for svc in self.target_services}
        ...
        for feature_name, query in queries.items():
            ...
            for res in results:
                ...
                elif feature_name in ["p50_latency", "p95_latency", "p99_latency", "cpu_usage", "memory_usage", "pod_restarts"]:
        ...
        for service in self.target_services:
            ...
            window = MetricWindow(
                ...
                timestamp=timestamp,
                feature_vector=raw_data[service]
            )
